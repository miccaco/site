...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="paciente.html"  ><span>Pesquisar paciente</span></a></li>
                      <li><a href="registrarpaciente.html" class="current"><span>Registrar paciente</span></a></li>                                                                           
...
<!-- CONTENT START -->
    ...
    <h1 class="content_edit">Registro de paciente</h1>
    </div>
...
<form id="edit" action="" method="post">
        ...
        <input type="text" class="smallInput wide" />
		<label>Sexo</label>
        <select name="time" class="smallInput wide" />
		...
		<label>Cep</label>
        <input type="text" class="smallInput wide" />
		<label>Data de nascimento :<input type='text' class='calendarSelectDate' size='10' name='calendario'/> </label>
